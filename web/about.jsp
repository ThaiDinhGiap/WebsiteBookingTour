<%-- 
    Document   : about
    Created on : Jul 4, 2024, 1:38:25 AM
    Author     : admin
--%>
            ...
            <div class="container">
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <h1 class="mb-4">Welcome to <span class="text-primary">Traveland</span></h1>
                        <p class="mb-4">At Traveland, we specialize in curating unique and exciting tours that cater to all your travel desires. Whether you're looking for a serene getaway, an adrenaline-pumping adventure, or a cultural immersion, we have the perfect tour for you.</p>
                        <p class="mb-4">Our expert team ensures every detail is meticulously planned, so all you need to do is relax and enjoy the journey. Join us at Traveland and discover the world in a whole new way!</p>
